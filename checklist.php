...
<body>
	...
	<div id="header_text" style="font-size: 20px; weight='bold'">SEARCH A PROJECT</div>
		...
		<a href="logout.php"><button class= "button"> LogOut </button></a>
			...
			<div id="formdiv">
				...
				SEARCH BY NAME:<br /><input type="text" name="search" placeholder="Project Name" onkeyup="showUser(this.value)"/><br />
	
<br>
<div id="txtHint" ><b><p style="margin-left: 10px;">Projects will be listed here.</p></b></div>
