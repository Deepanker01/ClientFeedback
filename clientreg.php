...
{
if(isset($_POST['email']) && isset($_POST['pass']) && isset($_POST['Name']) && isset($_POST['phone']) && isset($_POST['cname']) )
{
$email = $_POST['email'];
$pass = $_POST['pass'];
$name = $_POST['Name'];
...
$result = mysql_query("INSERT INTO `client`(`name`, `email`, `password`, `contact`, `company`) VALUES ('$name','$email','$pass','$phone','$cname')");
...
<body>
	...
	<div id="header_text" style="font-size: 20px; weight='bold'">CLIENT REGISTRATION FORM</div>
			<a href="indexclient.php" style="margin-left:530px;"> <?php if(isset($msg)) echo $msg ?> </a>
			<div id="formdiv">
				<form id="form" action="clientreg.php" method="post" onsubmit = "return vali()" name="myForm">
				<div id="crossdiv"><input type="reset" id="cross"/><br /></div>
				CLIENT EMAIL:<br /><input type="text" name="email" placeholder="Client Email" />
				...
				<br />
				COMPANY NAME:<br /><input type ="text" name = "cname" placeholder="Enter Company Name"/>
