...
$result = mysql_query("SELECT password,cid,name from `client` where email='$email'");
...
<body>
	...
	<div id="header_text" style="font-size: 20px; weight='bold'">CLIENT LOGIN</div>
			<div id="formdiv">
				<form id="form" action="indexclient.php" method="post">
				<div id="crossdiv"><input type="reset" id="cross"/><br /></div>
				CLIENT EMAIL:<br /><input type="text" name="email" placeholder="Client Email"/><br />
			...
			<a href="clientreg.php"><button class= "button"> Register Client </button></a>
			</div>	
     </div>
	</div>
