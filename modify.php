...
$pid = $_GET['pid'];
$_SESSION['ppid'] = $pid;
	$res = mysql_query("SELECT * FROM `project` WHERE pid='$pid'");
...
<body>
	...
	<div id="header_text" style="font-size: 20px; weight='bold'">MODIFY DETAILS</div>
    	  <a href="checkprogress2.php"><button class= "button"> Check the Progress </button></a> <br> <br> <br>
		<a href="checklist.php"><button class= "button"> Search Project </button></a> <br> <br> <br>
	
		<a href="logout.php"><button class= "button"> LogOut </button></a>
  	
			<div id="formdiv">
				<form id="form" action="modifydetails.php" method="post">
				<div id="crossdiv"><input type="reset" id="cross"/><br /></div>
				PROJECT NAME: <br /> <input type = "text" name="pname" placeholder="Project Name" value = "<?php echo $pname ?>" > <br>

				DEADLINE(DD-MM-YY):<br /><input type="date" name="deadline" placeholder="Project Deadline"  value="<?php echo $deadline ?>"/><br />
				

				MODULES: 
<?php
				 	$res2 = mysql_query("SELECT * FROM `modules` WHERE pid='$pid' LIMIT 5");
 while($row2 = mysql_fetch_array($res2))
 {

 	$modules = $row2['modules'];
  $status = $row2['status'];


 echo"<br /><input type='text' name='m1' placeholder='Module 1' value=".$modules."><br />";
...
TOTAL COMPLETION LEVEL
<br /><input type="text" name="level" placeholder="Completion Level" value="<?php echo $level ?>"/><br />
